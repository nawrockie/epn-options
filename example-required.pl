...
my %GetOptions_H = ();
my $usage    = "example-required.pl: print numbers up until a maximum ceiling\n\n";
   $usage   .= "Usage: example-required.pl --step <n> [-options] <ceiling: no numbers above this value will be printed>\n";
   $usage   .= "\nFor example:\nperl example-required.pl --step 2 10\n";
